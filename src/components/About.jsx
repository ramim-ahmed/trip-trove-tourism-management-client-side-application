...
export default function About() {
  return (
    <Fade>
      <div className="bg-[#f1f0f042] dark:bg-dark-color">
        <div className="max-w-6xl mx-auto py-20 px-3">
          <div className="grid grid-cols-12 items-center">
            ...
            <div className="lg:col-span-7 space-y-5 col-span-12 mt-10 lg:mt-0 text-center lg:text-start">
              ...
              <p>
                Trip Trove is a tourism management system (TMS) is a focus
                tourism service providers run and operate their enterprises. It
                is an entire platform that assists companies in streamlining
                processes, increasing efficiency, and improving customer
                support.
              </p>
